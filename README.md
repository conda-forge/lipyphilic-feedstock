...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/lipyphilic-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12092&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lipyphilic-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `lipyphilic` can be installed with:

```
conda install lipyphilic
```

It is possible to list all of the versions of `lipyphilic` available on your platform with:
